...
console.log("String - Number - Boolen - Null - Undefined");
...
console.log("Il tipo di dataType 'Undefined' indica l'assenza di una valore. Una variabile che non è stata mai inizializzata ");
console.log("********************************************************");
...
let num2 = 20;
let sum = num1 + num2;
console.log("La somma dei numeri " + num1 + " e " + num2 + " è: " + sum)
...
let x = 12; 
console.log("La variabile di nome x contiente il valore: " + x)
console.log("********************************************************");
